...
abstract class $BookModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {int? id, String category, String title, String author, double price});
}
...
class _$BookModelImpl extends _BookModel {
  ...
  @override
  String toString() {
    return 'BookModel(id: $id, category: $category, title: $title, author: $author, price: $price)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, category, title, author, price);
...
abstract class _BookModel extends BookModel {
  const factory _BookModel(
      ...
      required final double price}) = _$BookModelImpl;
